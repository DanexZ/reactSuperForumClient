...
import { faBold, faItalic, faUnderline, faCode, faHeading, faQuoteRight, faListOl, faListUl } from "@fortawesome/free-solid-svg-icons";
...
const RichEditor: FC<RichEditorProps> = ({ existingBody }) => {
    ...
    useEffect(() => {
        if (existingBody) setValue([{ type: "paragraph", text: existingBody }]);
    }, []);

    const onChangeEditorValue = (val: Node[]) => setValue(val);
