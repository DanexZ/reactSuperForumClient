...
const Login: FC<ModalProps> = ({ isOpen, onClickToggle }) => {
    ...
    const onChangeUserName = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (!e.target.value)allowSubmit(dispatch, "Nazwa użytkownika nie może być pusta", true);
    ...
    const onClickLogin = async (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        ...
        console.log("logowanie", result);
        execMe();
        updateMe();
    };

    const onClickCancel = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => onClickToggle(e);
